...
import 'package:ppkd_b_2/tugas_11_flutter/model/produk_model.dart';
...
class _Tugas11WishListBelanjaState extends State<Tugas11WishListBelanja> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Pendataan Produk Toko'), centerTitle: true),
            ...
            children: [
              ...
              ..._produkList.map(
                (produk) => ListTile(
                  ...
                  subtitle: Text(
                    'Oleh ${produk.namaPengguna} - ${produk.rating}/5',
                  ),
                ),
              ),
            ],
